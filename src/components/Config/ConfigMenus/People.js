      ...
      <div className="row">
        ...
        <div className="col s12">
          ...
          <div className="input-field col s12 m6">
            ...
            <input placeholder="Not Set" id="user-nickname" type="text" className="enabled" autoComplete="off" onChange={handleChangeNickname} />
          </div>
          ...
          <div className="input-field col s12 m6">
            ...
            <select className="browser-default" id="user-type-select" onChange={handleChangeUserType}>
              ...
              <option value="teacher">Cool kid(T)</option>
              <option value="student">Loser(S)</option>
            </select>
          </div>
        ...
        <div className="col s12 m6" style={{marginLeft: "0.5rem", marginTop: "0.5rem"}}>
          <div className="btn waves-effect surface text-onSurfaceVariant disabled" style={{height: "3rem"}} onClick={handleDeleteUser}>
          <i className="material-icons red-text text-lighten-1 disabled" style={{position: "relative", top: "0.325rem", left: "-0.25rem"}}>delete</i>
            Delete User
          </div>
        </div>
